  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className=" fixed left-1/2 overflow-hidden -translate-x-1/2 -translate-y-1/2 top-1/2 max-w-[640px] w-full h-[68vh] bg-slate-700 rounded-meedium flex flex-col outline-none">
